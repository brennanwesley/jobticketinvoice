...
export const authTranslations = {
  en: {
    ...
    signup: {
      ...
      techSignup: 'Create Technician Account',
      techDescription: 'Complete your profile to start creating job tickets',
      ...
      techRole: 'Technician',
      techRoleDescription: 'Field service technician who completes jobs',
      managerRole: 'Manager',
      managerRoleDescription: 'Company manager who oversees jobs and invoices',
    ...
    jobTypes: {
      pumpservicetechnician: 'Pump Service Technician',
      fieldmechanic: 'Field Mechanic',
      electrician: 'Electrician',
      instrumentationtechnician: 'Instrumentation Technician',
      other: 'Other',
    },
  ...
  es: {
    ...
    signup: {
      ...
      description: 'Elija su rol para comenzar',
      techSignup: 'Crear Cuenta de Técnico',
      techDescription: 'Complete su perfil para comenzar a crear boletas de trabajo',
      ...
      techRole: 'Técnico',
      techRoleDescription: 'Técnico de servicio de campo que completa trabajos',
      managerRole: 'Gerente',
      managerRoleDescription: 'Gerente de empresa que supervisa trabajos y facturas',
    ...
    // Job types for technicians
    jobTypes: {
      pumpservicetechnician: 'Técnico de Servicio de Bombas',
      fieldmechanic: 'Mecánico de Campo',
      electrician: 'Electricista',
      instrumentationtechnician: 'Técnico de Instrumentación',
      other: 'Otro',
    },
