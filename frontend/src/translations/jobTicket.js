...
export const jobTicketTranslations = {
  en: {
    ...
    jobTicket: {
      ...
      noSubmitted: 'No submitted tickets found',
      noDrafts: 'No draft tickets found',
  ...
  es: {
    ...
    jobTicket: {
      ...
      noSubmitted: 'No se encontraron boletas enviadas',
      noDrafts: 'No se encontraron boletas borrador',
