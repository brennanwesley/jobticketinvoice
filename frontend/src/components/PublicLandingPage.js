      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="md:w-1/2">
            {/* Replace the SVG placeholder with an attractive gradient card */}
            <div className="w-full max-w-md mx-auto bg-gradient-to-br from-orange-500 to-blue-600 rounded-lg shadow-lg p-8 text-white">
              <div className="flex flex-col items-center justify-center h-64">
                ...
                <h2 className="text-2xl font-bold mb-2 text-center">Job Ticket Platform</h2>
                <p className="text-center opacity-80">Streamline your oilfield service operations</p>
              </div>
            </div>
          </div>
        </div>
